package com.example.contentproviderkotlin
...
class MainActivity : AppCompatActivity() {
    ...
    private fun readcontact() {
        ...
        var adap =SimpleCursorAdapter(this,android.R.layout.simple_list_item_2,rs,from,to,0)
        ...
        searchView.setOnQueryTextListener(object: SearchView.OnQueryTextListener{
            ...
            override fun onQueryTextChange(p0: String?): Boolean {
                 rs= contentResolver.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI,cols,
                    "${ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME} LIKE ?", Array(1){"%$p0%"},
                    ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME)

                adap.changeCursor(rs)
